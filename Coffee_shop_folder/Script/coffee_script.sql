...
use coffee_sales_db;
SELECT * FROM coffee_sales_db.coffee_shop;
...
#COMPARING DAILY SALES WITH AVERAGE SALES KPI– IF GREATER THAN “ABOVE AVERAGE” and LESSER THAN “BELOW AVERAGE”
SELECT 
    day_of_month,
    CASE 
...
WHERE 
    ...
    #TO GET SALES FROM MONDAY TO SUNDAY FOR MONTH OF MAY KPI:
SELECT 
    CASE 
